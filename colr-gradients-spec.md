...
**Figure 5.27 A PaintGlyph and PaintSolid table are used to define the clock hour hand pointing to 12.**
...
**Figure 5.28 The sub-graphs for the hour hand are re-used with PaintRotate tables to point to different hours.**
